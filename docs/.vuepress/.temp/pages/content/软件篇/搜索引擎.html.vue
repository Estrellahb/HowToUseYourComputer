<template><div><h1 id="搜索引擎" tabindex="-1"><a class="header-anchor" href="#搜索引擎"><span>搜索引擎</span></a></h1>
<p>每个浏览器会自带一个默认的搜索引擎，edge自带bing，chrome自带google，国内的搜索引擎大多是baidu，
...
<li>在弹出的提示框点击 ‘添加拓展’</li>
<li>之后会弹出捐款提示框，有能力的建议支持一下。关闭该窗口能正常使用拦截广告的功能
我们来试一下效果，输入电脑推荐试试
<img src="@source/content/软件篇/image-3.png" alt="alt text">
怎么都是广告，哦，得去设置关掉这个选项
扩展——更多操作——扩展选项——关掉‘允许非入侵广告’
<img src="@source/content/软件篇/image-4.png" alt="alt text">
再让我们试一下，广告消失了
<img src="@source/content/软件篇/image-5.png" alt="alt text">
<strong>以上的操作能够极大提升你搜索信息的效率，减少上当受骗的可能</strong></li>
</ol>
<h2 id="信息检索" tabindex="-1"><a class="header-anchor" href="#信息检索"><span>信息检索</span></a></h2>
<p>近些年的国内，使用搜索引擎快速检索信息越发困难，大家都在做私域，比如微信公众号，你使用搜索引擎是搜不到里面任何内容的，这就需要去对应平台找到你需要的信息，所以你必须对多个平台的领域有所了解，知道它们在哪，怎么找。
国外大多以开源精神为主，搜索引擎能满足你绝大部分需要——前提你的会英语
这里提供一些精准搜索信息的技巧<em>以下标点符号都是英文的</em></p>
<ol>
<li>精准搜索 <code v-pre>&quot;&quot;</code>在你搜索的关键词加上双引号，精准匹配标题与文章关键字
<img src="@source/content/软件篇/image-6.png" alt="alt text"></li>
<li>站内搜索 <code v-pre>side:</code> 用法是在后面加上去掉<code v-pre>https://www.</code>的网址
<img src="@source/content/软件篇/image-7.png" alt="alt text"></li>
<li>文档搜索 <code v-pre>filetype</code> 用于搜索特定文件格式
<img src="@source/content/软件篇/image-8.png" alt="alt text"></li>
<li><code v-pre>《》</code> 搜索书籍著作
<img src="@source/content/软件篇/image-9.png" alt="alt text">
详细的可以看这位大佬<a href="https://www.cnblogs.com/liuzhongkun/p/15647486.html" target="_blank" rel="noopener noreferrer">https://www.cnblogs.com/liuzhongkun/p/15647486.html</a>
